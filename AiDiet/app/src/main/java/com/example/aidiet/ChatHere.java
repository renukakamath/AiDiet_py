...
public class ChatHere extends Activity  implements com.example.aidiet.JsonResponse
{
	EditText ed1;
	ImageView b1;
	String chat;
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		b1.setOnClickListener(new View.OnClickListener() 
		{
			public void onClick(View arg0)
			{
				...
				{
					com.example.aidiet.JsonReq JR=new com.example.aidiet.JsonReq();
			        JR.json_response=(com.example.aidiet.JsonResponse) ChatHere.this;
			        String q = "/chat?sender_id="+sh.getString("log_id", "")+"&receiver_id="+sh.getString("receiver_id", "")+"&details="+chat+"&hid="+viewhealthagent.hid;
			        q=q.replace(" ","%20");
			        JR.execute(q);
	...
	void getChats() {
			...
			com.example.aidiet.JsonReq JR=new com.example.aidiet.JsonReq();
	        JR.json_response=(com.example.aidiet.JsonResponse) ChatHere.this;
	        String q = "/chatdetail?sender_id="+sh.getString("log_id", "")+"&receiver_id="+sh.getString("receiver_id", "")+"&hid="+viewhealthagent.hid;
	        q=q.replace(" ","%20");
