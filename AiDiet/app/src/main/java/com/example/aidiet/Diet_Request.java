...
public class Diet_Request extends AppCompatActivity  implements JsonResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                JR.json_response = (JsonResponse) Diet_Request.this;
                String q = "/Diet_Request?login_id=" + sh.getString("log_id", "") + "&request=" +request ;
                q = q.replace(" ", "%20");
                JR.execute(q);
